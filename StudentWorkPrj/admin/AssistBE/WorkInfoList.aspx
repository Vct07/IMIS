<%@ Page Language="C#" AutoEventWireup="true" CodeFile="WorkInfoList.aspx.cs" Inherits="admin_WorkInfoList" %>
    ...
    <form id="form1" runat="server">
          <table border="0" cellspacing="1" class="Navi" width="98%">
            <tr>
                <th style="width: 930px; height: 24px">
                    <div id="TitleName" runat="server">Work list</div></th>
            </tr>
        </table>
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="ObjNum" HeaderText="Number left"  ItemStyle-Width="100px" />
                 <asp:BoundField DataField="Wages" HeaderText="Salary"  ItemStyle-Width="100px" />  
                <asp:BoundField DataField="CreateDate" HeaderText="Release time"  ItemStyle-Width="120px" />
                      
                <asp:TemplateField>
                    <ItemTemplate>
                        <a href='<%# string.Format("/admin/AssistBE/UpWorkInfo.aspx?id={0}&type=view",Eval("ID")) %>'>Details</a>                      
                    </ItemTemplate>
