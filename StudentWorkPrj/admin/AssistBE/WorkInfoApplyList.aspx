<%@ Page Language="C#" AutoEventWireup="true" CodeFile="WorkInfoApplyList.aspx.cs" Inherits="admin_WorkInfoApplyList" %>
<%@ Register Assembly="UcfarPager" Namespace="UcfarPager" TagPrefix="cc1" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Work apply list</title>
        ...
        <table border="0" cellspacing="1" class="Navi" width="98%">
            <tr>
                <th style="width: 930px; height: 24px">
                    <div id="TitleName" runat="server">Work apply list</div></th>
            </tr>
        </table>
        <br />
        <asp:DropDownList ID="Select_Filed" runat="server">
           <asp:ListItem Value="all" Selected="True">All</asp:ListItem>
            <asp:ListItem Value="xh">Student ID</asp:ListItem>
            <asp:ListItem Value="gs">Company</asp:ListItem>
            <asp:ListItem Value="zw">Position</asp:ListItem>
            <asp:ListItem Value="gj">Customized</asp:ListItem>
        </asp:DropDownList>
        
          <asp:TextBox  name="keyword" ID="keyword"  runat="server" Width="571px" Height="20px"></asp:TextBox>&nbsp;
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False"
            ...
            <Columns>
                <asp:TemplateField HeaderText="id" Visible="False">
                 ...
                 <asp:BoundField DataField="NickName" HeaderText="Name"  ItemStyle-Width="100px" />  
                 ...
                 <asp:BoundField DataField="PostName" HeaderText="Work"  ItemStyle-Width="120px" />    
                ...
                <asp:BoundField DataField="ObjNum" HeaderText="Approved number"  ItemStyle-Width="100px" />
               ...
               <asp:TemplateField HeaderText=""> 
                  ...
                  <asp:ImageButton ToolTip="Agree" ID="aggree" ImageUrl="../images/Reset.png" CommandName="AggreeApply" CssClass="LinkStyle" Width="15px" Height="11px" runat="server" PostBackUrl='<%# Eval("ID") %>'  CommandArgument='<%# Eval("WorkObjID") %>'/></div>                     
                  </ItemTemplate>
